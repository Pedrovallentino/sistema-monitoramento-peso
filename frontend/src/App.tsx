          ...
          <div className="space-y-6 md:space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 items-stretch">
              ...
              <div className="flex flex-col gap-6 order-2 xl:order-1">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-6 flex-1 h-full">
                  <div className="flex items-center gap-3 mb-4">
                     <div className="p-2 bg-blue-50 rounded-lg text-blue-600">
                       <Activity size={20} />
                     </div>
                     <h4 className="font-semibold text-gray-700">Resumo de Consumo</h4>
                  </div>
              ...
              <div className="flex flex-col gap-6 order-3 xl:order-3">
                 <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-6 flex-1">
                    <div className="flex items-center gap-3 mb-6">
                       <div className="p-2 bg-purple-50 rounded-lg text-purple-600">
                         <Clock size={20} />
                       </div>
                       <h4 className="font-semibold text-gray-700">Última Atividade</h4>
                    </div>
                    ...
                    <div className="space-y-4 md:space-y-6">
                      ...
                      <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                        <span className="text-gray-600 font-medium text-sm md:text-base">Latência da Rede</span>
      ...
      case 'history':
        return (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-slide-up">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Histórico Completo</h2>
            <SwapHistoryTable />
          </div>
        );
      case 'charts':
        return (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-in slide-in-from-bottom-4 duration-500 h-[500px]">
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden transition-all duration-300">
        {/* Topbar */}
        <header className="bg-white/80 backdrop-blur-md border-b border-gray-200 h-16 md:h-20 z-10 sticky top-0 transition-all duration-300 w-full">
          <div className="w-full px-4 md:px-8 h-full flex items-center justify-between">
            <div className="flex items-center gap-3 md:gap-4">
            <button 
              className="text-gray-600 hover:bg-gray-100 p-3 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 touch-manipulation"
            ...
            <div>
              <h2 className="text-lg md:text-xl font-bold text-gray-800 capitalize tracking-tight truncate max-w-[200px] md:max-w-none">
            ...
            <div className="flex items-center gap-3 md:gap-6">
              ...
              <div className="flex items-center gap-2 md:gap-3 bg-gray-50 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-gray-100">
                ...
                <span className="text-xs md:text-sm font-medium text-gray-600 hidden sm:inline">
